...
public class Menu extends javax.swing.JPanel {
    ...
    if (levelUser != null && levelUser.equals("Admin")) {
        ...
        listMenu.addItem(new ModelMenu("anggota_white", "Member", ModelMenu.MenuType.MENU));
        listMenu.addItem(new ModelMenu("kategori_white", "Kategori", ModelMenu.MenuType.MENU));
        listMenu.addItem(new ModelMenu("penerbit_white", "Brand Produk", ModelMenu.MenuType.MENU));
        listMenu.addItem(new ModelMenu("book_white", "Produk", ModelMenu.MenuType.MENU));
        listMenu.addItem(new ModelMenu("petugas_white", "Karyawan", ModelMenu.MenuType.MENU));
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#01a6cc"), 0, getHeight(), Color.decode("#430957"));
        g2.setPaint(g);
    ...
    private void initComponents() {
        ...
        listMenu = new com.kasir.menu.ListMenu<>();
        ...
        title.setText("Konoha Mart");

        logo.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        logo.setForeground(new java.awt.Color(102, 102, 102));
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/kasir/icon/Logo.png"))); // NOI18N
        ...
        jLabel3.setText("AppKasir v3.0.0");
    ...
    private com.kasir.menu.ListMenu<String> listMenu;
