...
public class MasterKaryawan extends javax.swing.JPanel {
    ...
    private int getTotalData(){
        ...
        try {
            ...
            Logger.getLogger(MasterKaryawan.class.getName()).log(Level.SEVERE,null,e);
        }
    ...
    private void showPanel(){
        panelMain.removeAll();
        panelMain.add(new MasterKaryawan());
        panelMain.repaint();
        panelMain.revalidate();
    }
  ...
  private void setTabelModel() {
    ...
    private String setIDUser(){
        ...
        try (PreparedStatement st = conn.prepareStatement(sql)){
            ...
            java.util.logging.Logger.getLogger(MasterKaryawan.class.getName()).log(Level.SEVERE, null, e);
        }
