...
public class MasterMember extends javax.swing.JPanel {
    ...
    private void setLayoutForm(){
        ...
        iconJudul2.setIcon(new FlatSVGIcon("com/kasir/icon/anggota.svg", 1f));
        ...
        txtID.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "ID Member");
        txtNama.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Masukkan Nama Member");
        txtEmail.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Masukkan Email Member");
        txtTelepon.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Masukkan Nomor Telepon Member ");
        txtTanggal.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Masukkan Tanggal Bergabung Member ");
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Tambah Data Member");

        jLabel6.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(102, 102, 102));
        jLabel6.setText("Master Data > Member");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        if (row!=-1) {
            ...
            try {
                String reportPath = "src/com/kasir/reports/KartuAnggota.jasper";
   ...
   private int getTotalData() {
    ...
    try {
        // SQL query untuk menghitung hanya user dengan level Kasir
        ...
        Logger.getLogger(MasterMember.class.getName()).log(Level.SEVERE, null, e);
    }
    ...
    private void showPanel(){
        panelMain.removeAll();
        panelMain.add(new MasterMember());
        panelMain.repaint();
        panelMain.revalidate();
    }
    ...
    // Membuat DefaultTableModel kustom dengan isCellEditable dioverride
    ...
    public void getData(int startIndex, int entriesPage, DefaultTableModel model) {
        ...
        try {
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    String idAnggota = rs.getString("ID_Member");
                    String namaAnggota = rs.getString("Nama_Member");
    ...
    private String setIDAnggota(){
        ...
        String sql = "SELECT RIGHT(ID_Member, 3) AS Nomor " +
                     "FROM member " +
                     "WHERE ID_Member LIKE 'MBR" + no + "%' " +
        ...
        try (PreparedStatement st = conn.prepareStatement(sql)){
            ...
            if (rs.next()) {
                ...
                urutan = "MBR" + no + String.format("%03d", nomor);
            }else{
                urutan = "MBR" + no + "001";
            }
            
        } catch (SQLException e) {
            java.util.logging.Logger.getLogger(MasterMember.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private void insertData() {
        ...
        try {
            String sql = "INSERT INTO member (ID_Member, Nama_Member, Email, Telepon, Jenis_Kelamin, Tanggal_Bergabung) VALUES (?,?,?,?,?,?)";
            try(PreparedStatement st = conn.prepareStatement(sql)){
    ...
    private void dataTabel() {
        ...
        int row = tblData.getSelectedRow();
        jLabel5.setText("Perbarui Data Member");
    ...
    private void updateData() {
        ...
        try {
            String sql = "UPDATE member SET Nama_Member=?, Email=?,Telepon=?,Jenis_Kelamin=?,Tanggal_Bergabung=? WHERE ID_Member=?";
            try(PreparedStatement st = conn.prepareStatement(sql)){
    ...
    private void searchData() {
        ...
        try {
            String sql = "SELECT * FROM member WHERE Nama_Member LIKE ? OR Email LIKE ?";
            try (PreparedStatement st = conn.prepareStatement(sql)){
