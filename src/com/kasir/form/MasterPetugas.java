...
public class MasterPetugas extends javax.swing.JPanel {
    ...
    private void setLayoutForm(){
        iconJudul.setIcon(new FlatSVGIcon("com/kasir/icon/petugas.svg", 1f));
        iconJudul2.setIcon(new FlatSVGIcon("com/kasir/icon/petugas.svg", 1f));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Master Data > Karyawan");
        ...
        jLabel6.setText("Master Data > Karyawan");
        ...
        cbxLevel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Pilih Level-", "Admin", "Kasir", "Owner" }));
                ...
                .addGroup(panelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelAddLayout.createSequentialGroup()
                        .addGroup(panelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cbxLevel, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private int getTotalData(){
        ...
        try {
            ...
            Logger.getLogger(MasterPetugas.class.getName()).log(Level.SEVERE,null,e);
        }
    ...
    private void showPanel(){
        panelMain.removeAll();
        panelMain.add(new MasterPetugas());
        panelMain.repaint();
        panelMain.revalidate();
    }
        ...
        try {
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    Object[] rowData = {"   " + no++, idUser, namaUser, userName, emailUser, levelUser};
    ...
    private String setIDUser(){
        ...
        try (PreparedStatement st = conn.prepareStatement(sql)){
            ...
            java.util.logging.Logger.getLogger(MasterPetugas.class.getName()).log(Level.SEVERE, null, e);
        }
