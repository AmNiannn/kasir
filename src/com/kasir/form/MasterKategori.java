...
public class MasterKategori extends javax.swing.JPanel {
    ...
    private void setLayoutForm(){
        iconJudul.setIcon(new FlatSVGIcon("com/kasir/icon/kategori.svg", 1f));
        iconJudul2.setIcon(new FlatSVGIcon("com/kasir/icon/kategori.svg", 1f));
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Tambah Data Kategori Produk");
        ...
        try {
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    Object[] rowData = {"   " + no++, idKategori, namaKategori, deskripsiKategori};
