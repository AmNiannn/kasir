...
public class KeuanganHarian extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Laporan > Pendapatan Harian");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelViewLayout.createSequentialGroup()
                        ...
                        .addGroup(panelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelViewLayout.createSequentialGroup()
                                ...
                                .addComponent(txtPendapatan, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(20, 20, 20))
        );
        panelViewLayout.setVerticalGroup(
            ...
            .addGroup(panelViewLayout.createSequentialGroup()
                ...
                .addGroup(panelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtPendapatan, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    // End of variables declaration//GEN-END:variables
        ...
        private void initializeTanggalFields() {
        try {
            // Mendapatkan tanggal hari ini
            String today = dateFormat.format(new Date());
            tanggalMulai = dateFormat.parse(today);
            tanggalAkhir = dateFormat.parse(today);

            // Atur nilai tanggal ke text field
            txtTanggalMulai.setText(today);
            txtTanggalMulai.setEditable(false); // Buat tidak dapat diedit

            txtTanggalAkhir.setText(today);
            txtTanggalAkhir.setEditable(false); // Buat tidak dapat diedit
...
private void setTabelModel() {
    ...
    private void cetakLaporan(){
        ...
        try {
            String reportPath = "src/com/kasir/reports/LaporanTransaksi.jasper";
