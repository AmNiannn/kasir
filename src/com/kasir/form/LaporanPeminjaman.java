...
public class LaporanPeminjaman extends javax.swing.JPanel {
    ...
    private void initComponents() {
                        ...
                        .addGroup(panelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelViewLayout.createSequentialGroup()
                                ...
                                .addGroup(panelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE))))))
                .addGap(20, 20, 20))
        );
        panelViewLayout.setVerticalGroup(
            ...
            .addGroup(panelViewLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtPendapatan, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public void keyReleased(KeyEvent e) {
        int startIndex = 0;  // Misalnya, 0 untuk halaman pertama
        int entriesPage = 10; // Jumlah entri per halaman (misalnya 10)

        // Panggil method searchData dengan parameter startIndex dan entriesPage
        searchData(startIndex, entriesPage);
    }
});
    ...
    private void searchData(int startIndex, int entriesPage) {
    ...
    try {
        ...
        String sql = "SELECT trs.ID_Transaksi, trs.Tanggal_Transaksi, trs.Total_Harga, trs.Bayar, trs.Diskon, trs.Kembali, "
                   + "mbr.ID_Member, mbr.Nama_Member, usr.ID_User, usr.Nama_User "
                   + "FROM transaksi trs "
                   + "INNER JOIN member mbr ON mbr.ID_Member = trs.ID_Member "
                   + "INNER JOIN user usr ON usr.ID_User = trs.ID_User "
                   + "WHERE (trs.ID_Transaksi LIKE ? OR mbr.Nama_Member LIKE ? OR usr.Nama_User LIKE ?) "
                   + "AND trs.Tanggal_Transaksi BETWEEN ? AND ? "
                   + "ORDER BY trs.ID_Transaksi ASC "
                   + "LIMIT ?, ?";
        
        try (PreparedStatement st = conn.prepareStatement(sql)) {
            // Menetapkan parameter untuk pencarian kata kunci
            ...
            // Menetapkan parameter untuk LIMIT
            st.setInt(6, startIndex);
            st.setInt(7, entriesPage);
            ...
            while (rs.next()) {
                ...
                Object[] rowData = {"   " + no++, idTransaksi, tanggalTransaksi, totalHarga, bayar, diskon, kembali, idMember, namaMember, idUser, namaUser};
                model.addRow(rowData);
            }

            TotalBiaya(); // Jika ada perhitungan biaya total yang perlu dilakukan.
        } catch (SQLException e) {
            Logger.getLogger(LaporanPeminjaman.class.getName()).log(Level.SEVERE, null, e);
        }
    } catch (ParseException ex) {
