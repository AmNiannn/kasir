...
public class DataPenjualan extends javax.swing.JDialog {
    ...
    public DataPenjualan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataPenjualan dialog = new DataPenjualan(new javax.swing.JFrame(), true);
    ...
    public void getData(int startIndex, int entriesPage, DefaultTableModel model) {
        ...
        try {
            String sql = "SELECT *\n" +
                    "FROM detail_transaksi trs\n" +
                    "INNER JOIN transaksi tr ON tr.ID_Transaksi = trs.ID_Transaksi\n" +
                    "INNER JOIN member mbr ON mbr.ID_Member = tr.ID_Member\n" +
                    "INNER JOIN produk pd ON pd.ID_Produk = trs.ID_Produk\n" +
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    String tanggalPinjam    = rs.getString("Tanggal_Transaksi");
